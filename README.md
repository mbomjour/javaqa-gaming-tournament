# Использование коллекций для работы с наборами элементов

## Задание 1

Ваша задача — разработать класс, управляющий турниром игроков. Каждый игрок описывается дата-классом `Player` с полями `id`, `name`, `strength`.
